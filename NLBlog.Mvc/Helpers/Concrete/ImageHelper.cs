...
namespace NLBlog.Mvc.Helpers.Concrete
{
    public class ImageHelper : IImageHelper
    {
        ...
        public IDataResult<ImageDeletedDto> Delete(string pictureName)
        {
            ...
            {
                return new DataResult<ImageDeletedDto>(ResultStatus.Error,null, message: "Böyle Bir dosya bulunamadı");
            }
        }
        ...
        public async Task<IDataResult<ImageUploadedDto>> UploadUserImage(string userName, IFormFile pictureFile, string folderName="userImages")
        {
            ...
            },message: $"{userName} adlı kullanıcı resimi başarıyla yüklenmiştir");
        }
    }
}
