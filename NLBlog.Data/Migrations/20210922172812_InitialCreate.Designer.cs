...
namespace NLBlog.Data.Migrations
{
    ...
    [Migration("20210922172812_InitialCreate")]
            ...
            modelBuilder.Entity("NLBlog.Entities.Concrete.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2021, 9, 22, 20, 28, 11, 641, DateTimeKind.Local).AddTicks(3769),
                            Description = "C# ile ilgili bilgiler",
                            IsActive = true,
                            IsDeleted = false,
                            ModifiedByName = "InitialCraete",
                            ModifiedDate = new DateTime(2021, 9, 22, 20, 28, 11, 641, DateTimeKind.Local).AddTicks(4141),
                            Name = "C#",
                        ...
                        new
                        {
                            Id = 2,
                            CreatedByName = "InitialCreate",
                            CreatedDate = new DateTime(2021, 9, 22, 20, 28, 11, 641, DateTimeKind.Local).AddTicks(4471),
                            Description = "C++ ile ilgili bilgiler",
                            IsActive = true,
                            IsDeleted = false,
                            ModifiedByName = "InitialCraete",
                            ModifiedDate = new DateTime(2021, 9, 22, 20, 28, 11, 641, DateTimeKind.Local).AddTicks(4472),
                            Name = "C++",
                            Note = "C++ Blog Kategorisi"
                        },
                        new
                        {
                            Id = 3,
                            CreatedByName = "InitialCreate",
                            CreatedDate = new DateTime(2021, 9, 22, 20, 28, 11, 641, DateTimeKind.Local).AddTicks(4476),
                            Description = "Java Script ile ilgili bilgiler",
                            IsActive = true,
                            IsDeleted = false,
                            ModifiedByName = "InitialCraete",
                            ModifiedDate = new DateTime(2021, 9, 22, 20, 28, 11, 641, DateTimeKind.Local).AddTicks(4477),
                            Name = "Java Script",
